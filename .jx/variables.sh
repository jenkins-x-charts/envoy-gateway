...
export JENKINS_X_URL='https://dashboard-jx.infra.jenkins-x.rocks/jenkins-x-charts/envoy-gateway/main/7'
...
export MINK_IMAGE='ghcr.io/jenkins-x/envoy-gateway:0.1.1'
